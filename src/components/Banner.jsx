...
export const Banner = () => {
  ...
  >
    <div>
        ...
        <motion.div className='flex flex-col absolute bottom-0 top-0 lg:top-60 left-0 md:left-40 bg-black/60 text-white px-3 py-4 w-52 h-40 mx-auto my-auto rounded-lg  justify-center md:w-2/6 lg:w-4/12 lg:h-60 lg:px-5 z-10'
