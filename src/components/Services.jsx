...
export const Services = () => {
  ...
  return (
    <div className='px-10 my-10 md:px-32 lg:px-44'>
        <h1 className='font-serif  text-5xl my-5 md:text-7xl lg:8xl '>Our Services</h1>
        <span className='font-mono text-center text-base text-gray-500 md:my-5 md:text-xl lg:text-2xl'>We provide students with a wide spectrum of opportunities</span>
        <List 
        items={services}
        />
    </div>
