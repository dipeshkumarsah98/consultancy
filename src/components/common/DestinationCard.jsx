...
export const DestinationCard = ({photo, heading, description, link, parent}) => {
  return (
<motion.div variants={parent} className='pb-4  bg-slate-100 flex flex-col text-black space-y-3 drop-shadow-2xl justify-center rounded-xl'>
