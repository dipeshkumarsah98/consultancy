...
export const Card = ({title, desc, link, parent}) => {
  return (
    <motion.div variants={parent} className='border-2 border-slate-300 py-5 px-3 rounded-lg  md:px-8 md:my-10 hover:shadow-lg hover:transition-colors md:space-y-2 lg:space-y-5'>
